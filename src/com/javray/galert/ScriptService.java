...
public class ScriptService extends ForegroundService {
	...
	protected Notification createNotification() {
	    ...
	    Intent mainIntent = new Intent(this, ScriptActivity.class);
	    mainIntent.setAction("android.intent.action.MAIN"); 
        mainIntent.addCategory("android.intent.category.LAUNCHER");
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_RESET_TASK_IF_NEEDED|Intent.FLAG_ACTIVITY_NEW_TASK);
	    PendingIntent contentIntent = PendingIntent.getActivity(this, 0, mainIntent, 0);
	    notification.setLatestEventInfo(getApplicationContext(), this.getString(R.string.app_name), this.getString(R.string.loading), contentIntent);
